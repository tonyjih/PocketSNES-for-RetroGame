...
void upscale_256x224_to_320x240_bilinearish(uint32_t* dst, uint32_t* src, int width)
{
	...
	for (BlockY = 0; BlockY < 14; BlockY++)
	{
		...
		BlockDst = Dst16 + BlockY * 320 * 17 * 2;
		for (BlockX = 0; BlockX < 64; BlockX++)
		{
			...
			*(BlockDst + 320 *  6    ) = Weight1_3( _9, _13);
			...
			*(BlockDst + 320 *  8    ) = Weight1_3(_13, _17);
			...
			*(BlockDst + 320 *  10    ) = Weight1_3(_17, _21);
			...
			*(BlockDst + 320 *  12    ) = Weight1_3(_21, _25);
			...
			*(BlockDst + 320 *  14    ) = Weight1_3(_25, _29);
			...
			*(BlockDst + 320 *  16    ) = Weight1_1(_29, _33);
			...
			*(BlockDst + 320 *  18    ) = Weight3_1(_33, _37);
			...
			*(BlockDst + 320 * 20    ) = Weight3_1(_37, _41);
			...
			*(BlockDst + 320 * 22    ) = Weight3_1(_41, _45);
			...
			*(BlockDst + 320 * 24    ) = Weight3_1(_45, _49);
			...
			*(BlockDst + 320 * 26    ) = Weight3_1(_49, _53);
